...
<title>AdsDeliver Change ContentPrice</title>
</head>
<body>
					...
					<div class="form">
						<div class="fields">
							<div class="field field-first">
								<div class="label">
									<label for="input">请输入合适的Content单价:</label>
								</div>
								<div class="input">
									<input type="text" id="input" name="input" class="medium validate[required,min[1],max[20]]" />
